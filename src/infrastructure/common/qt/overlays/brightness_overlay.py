...
class BrightnessOverlay(BaseOverlay):
    """Fullscreen overlay with a screen-brightness slider."""
    ...
    def __init__(self, gamepad: PadControl, brightness: BrightnessControl, feedback: Feedback, parent: QWidget | None = None):
        ...
        icon_lbl = QLabel()
        icon_lbl.setPixmap(qta.icon("fa5s.sun", color="white").pixmap(32, 32))
        icon_lbl.setStyleSheet("background: transparent;")
        title = QLabel("Jasność")
        ...
        self._slider.setValue(self._brightness.value)
        ...
        self._slider.setStyleSheet("""
            ...
            QSlider::sub-page:horizontal {
                background: #ebcb8b; border-radius: 4px;
            }
        ...
        # Value
        self._value_lbl = QLabel(f"{self._brightness.value}%")
    ...
    def _change(self, delta: int) -> None:
        self._brightness = self._brightness.adjusted(delta)
        self._slider.setValue(self._brightness.value)
        self._value_lbl.setText(f"{self._brightness.value}%")
        self._control.set(self._brightness)
