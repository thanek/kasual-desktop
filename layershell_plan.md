...
- [ ] uprościć `BaseOverlay` (koniec dualnego trybu); zmigrować `ConfirmDialog`/`VolumeOverlay`/`TilePopover`/`InfoDialog` na wrapper → **naprawia bug z dialogami nie na wierzchu** (zgłoszony w Fazie 1)
