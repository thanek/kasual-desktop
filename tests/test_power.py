...
class TestSystemdPowerControl:
    def test_suspend(self):
        with patch("infrastructure.kde.power.power.subprocess.Popen") as popen:
    ...
    def test_swallows_errors(self):
        with patch("infrastructure.kde.power.power.subprocess.Popen", side_effect=FileNotFoundError):
